...
GameWindow {
    ...
    MenuScene {
        ...
        onCreditsPressed: window.state = "credit"
    ...
    //credit scene to display creators meseage
    CreditScene{
        id:creditScene
    ...
    states: [
        ...
        State{
            name:"credit"
            PropertyChanges {target: creditScene; opacity: 1}
            PropertyChanges {target: window; activeScene: creditScene}
        }
